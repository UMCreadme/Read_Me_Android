...
import com.example.readme.ui.home.Feed.comment.CommentFragment


class Feed2Adapter(var list: ArrayList<FeedInfo>, private val fragmentManager: FragmentManager)
: RecyclerView.Adapter<Feed2Adapter.FeedHolder>() {
    ...
    inner class FeedHolder(val binding: FeedItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        val timestamp = binding.timestamp       // 타임스탬프z
        val commentIcon = binding.comment
    }
