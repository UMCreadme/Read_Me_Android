...
public final class FragmentPlaceBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout navPlace;

  private FragmentPlaceBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout navPlace) {
  ...
  public static FragmentPlaceBinding bind(@NonNull View rootView) {
    ...
    FrameLayout navPlace = (FrameLayout) rootView;

    return new FragmentPlaceBinding((FrameLayout) rootView, navPlace);
  }
}
