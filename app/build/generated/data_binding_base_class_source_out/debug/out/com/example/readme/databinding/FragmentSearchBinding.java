...
public abstract class FragmentSearchBinding extends ViewDataBinding {
  @NonNull
  public final TabLayout storeFragmentTablayout;
  ...
  protected FragmentSearchBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TabLayout storeFragmentTablayout, FrameLayout tabLayoutContainer) {
    super(_bindingComponent, _root, _localFieldCount);
    this.storeFragmentTablayout = storeFragmentTablayout;
