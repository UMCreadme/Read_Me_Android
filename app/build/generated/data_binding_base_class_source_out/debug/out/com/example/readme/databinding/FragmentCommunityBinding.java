...
public final class FragmentCommunityBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView fragmentNameText;

  private FragmentCommunityBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView fragmentNameText) {
    this.rootView = rootView;
    this.fragmentNameText = fragmentNameText;
  }
  ...
  public static FragmentCommunityBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.fragment_name_text;
      TextView fragmentNameText = ViewBindings.findChildViewById(rootView, id);
      if (fragmentNameText == null) {
        break missingId;
      }

      return new FragmentCommunityBinding((ConstraintLayout) rootView, fragmentNameText);
    }
