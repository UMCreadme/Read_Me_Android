...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.main_Logo, 3);
        sViewsWithIds.put(R.id.btn_filter, 4);
        sViewsWithIds.put(R.id.btn_setting, 5);
        sViewsWithIds.put(R.id.btn_back, 6);
        sViewsWithIds.put(R.id.nav_host_fragment, 7);
        sViewsWithIds.put(R.id.bottom_navigation_view, 8);
    }
    // views
    @NonNull
